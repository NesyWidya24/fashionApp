...
export default class HomeMen extends Component {
	render() {
		return (
			<Container>
					...
					<ScrollView style={styles.scrollView}>
						<Content>
							<SafeAreaView>
								...
								<ImageBackground style={styles.imgset} source={require('../images/men2.png')}>
									<Text
										style={{
											margin: '5%',
											color: 'white',
								...
								<View style={{ flex: 1, flexDirection: 'row' }}>
									<View style={styles.RectangleWhiteView}>
										...
										>
											...
											<Text style={styles.textDesc}>Eid Mubarak</Text>
										</TouchableOpacity>
									</View>
									<View style={styles.RectangleWhiteView}>
										<TouchableOpacity
